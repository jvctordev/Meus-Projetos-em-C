...
/*
   ...
   - Exibe 'msgErro' e repete ate receber um numero dentro do intervalo de cada jogo*/
...
int main() {
    ...
    srand(time(NULL)); //inicializa o gerador de numeros aleatorios com a hora atual, para garantir que os numeros sejam diferentes a cada execução do programa
